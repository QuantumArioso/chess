...
public class ClientHelper {
    ...
    public void gameplayLoop(PrintStream out, Scanner scanner, ChessGame.TeamColor teamColor,
    ...
    public int gameplayHelpMessage(PrintStream out, Scanner scanner) {
        out.println("""
    ...
    public void makeMove(PrintStream out, Scanner scanner, ChessGame game, String authToken, int gameID)
            throws IOException {
        out.println("""
    ...
    public ChessPosition validateCoordinate(PrintStream out, String input, ChessGame game, boolean start,
                                             String authToken, int gameID) throws IOException {
    ...
    public void resignFromGame(PrintStream out, Scanner scanner, String authToken, int gameID) {
        out.println("""
    ...
    public void highlightLegalMoves(PrintStream out, Scanner scanner, ChessGame game,
    ...
    public int preLoginHelpMessage(PrintStream out, Scanner scanner) {
        out.println("""
                Enter the number next to the option you wish to select:
                1. Help
    ...
    public String login(PrintStream out, Scanner scanner) {
        out.println("""
    ...
    public void exit(PrintStream out) {
        out.println("I bid thee farewell. Safe travels!");
        System.exit(0);
    }

    public int postLoginHelpMessage(PrintStream out, Scanner scanner) {
        out.println("""
                Enter the number next to the option you wish to select:
                1. Help
                2. Logout
    ...
    public String logout(PrintStream out, String authToken) {
        out.println("""
                See you later!
                """);
        try {
    ...
    public void createGame(PrintStream out, Scanner scanner, String authToken) {
        out.println("""
    ...
    public void listGames(PrintStream out, String authToken) {
        out.println("""
    ...
    public void joinGame(PrintStream out, Scanner scanner, String authToken) {
        out.println("""
    ...
    public void getGameIds(ArrayList<Integer> gameIDs, ArrayList<GameData> list) {
    ...
    public void observeGame(PrintStream out, Scanner scanner, String authToken) {
        out.println("""
    ...
    public void redrawChessBoard(boolean needToFlip, ChessGame game, ChessPosition pos, ChessBoard newBoard) {
